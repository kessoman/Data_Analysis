...
% [hb,pvalb,ciboot,stats] = ttest(muBoot);
% lowerboot = ciboot(1);
% upperboot = ciboot(2);
...
% Exoume loipon ena deigma me 11 parathrhseis kai meso xrono ysterhshs 4.72
...
% [1.6620,7.7925] ara ginetai fanero pws to 14 den anhkei se ayto kai ara de
% mporoyme na apodextoyme thn ypothesi oti o xronos ysterhshs einai 14
% hmeres.
% Parathroyme oti sto bootstrap diasthma epmpistosynhs ta oria einai: 
