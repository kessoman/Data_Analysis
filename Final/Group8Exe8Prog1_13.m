...
%     lambda = input('Choose lambda > such as only 2 vars remain: \n')
...
%     xlabel('Y')
%     ylabel('Yhat')
%     title('Scatter Diagram Yhat vs Y: LASSO')
%     txt = (['Erotima8_Fig',int2str(cfig),'']);
...
%     txt = (['My_exercise6_6_Fig',int2str(cfig),'']);
%     saveas(gcf,[dir,txt,'.jpg'])
    hold off
    cfig = cfig +1 ;
...
%     saveas(gcf,[dir,txt,'.jpg'])
    ...
    fprintf('\nLASSO Model - %d Variables, mi = %2.3f \n',dlasso(i),lambda(i))
...
% epilexthikan ek twn proterwn oi times mi gia kathe xwra.
...
% To symperasma poy prokyptei einai oti an thelame na kanoyme mia ektimhsh 
% twn thanatwn apo ta kroysmata synolika gia oles tis xwres gia mia mera,
% tha mporoysame na exetasoyme ta kroysmata ews kai mia evdomada pisw, me 
% pio shmantikes meres, thn 6h kai thn 7h.
