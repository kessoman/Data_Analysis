...
dir1 = 'C:\MATLAB\Data_Analysis\Project\Figures_Erotima5\RegressionFit\';
dir2 = 'C:\MATLAB\Data_Analysis\Project\Figures_Erotima5\DiagPlot\';
...
%         hold off
%         txt1 = (['Erotima5_Fig',int2str(cfig),'']);
...
%         txt2 = (['Erotima5_Fig',int2str(cfig),'']);
...
%         cfig = cfig + 1;
    ...
    fprintf('---------------------------------------------\n')
%     cd 'C:\MATLAB\Data_Analysis\Project\Figures_Erotima5\RegressionFit\'
%     if i>1
%         if rem(i,2)==1 
%             openfig(['Erotima5_Fig',int2str((indxr2(i)-1+21)+(i-1)*42),'.fig'])
%         elseif rem(i,2)==0
%             openfig(['Erotima5_Fig',int2str((indxr2(i)+21)+(i-1)*42),'.fig'])
%         end
%     else
%         openfig(['Erotima5_Fig',int2str((indxr2(i)+21)+(i-1)*42),'.fig'])
%     end
%     title(sprintf(['Scatter Plot: ',country,', Best LMS Fit, (according to rho^2)']))
%     txt = (['Erotima5_BestFig',int2str(cfig2),'']);
%     saveas(gcf,[dir1,txt,'.jpg'])
%     cfig2 = cfig2 + 1;
%     cd 'C:\MATLAB\Data_Analysis\Project\Figures_Erotima5\DiagPlot\'
%     if rem(i,2)==0
%         openfig(['Erotima5_Fig',int2str((indxr2(i)+21)+(i-1)*42 + 1),'.fig'])
%     elseif rem(i,2)==1
%         openfig(['Erotima5_Fig',int2str((indxr2(i)+21)+(i-1)*42),'.fig'])
%     end
%     title(sprintf(['Diagnostic Plot: ',country,', Best Diagn.Plot, (according to rho^2)']))
%     txt = (['Erotima5_BestFig',int2str(cfig2),'']);
%     saveas(gcf,[dir2,txt,'.jpg'])
%     cfig2 = cfig2 + 1;
...
% thanatwn kai ths ektimhshs ths timhs twnthanatwn poy ypologizei to
% montelo.
...
% diagn?stiko diagramma kai to ground truth plot dhladh to diagramma ths 
...
% Genika fainetai oti ta rho^2 einai arketa mikra (kai ta NRMSE sxetika megala
